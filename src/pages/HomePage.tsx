...
const actionCards = [
  { title: "AI Topic Finder", description: "Get AI-powered topic suggestions", icon: Sparkles, color: "bg-primary/10 text-primary" },
  { title: "Find Experts", description: "Connect with industry experts", icon: Users, color: "bg-emerald-100 text-emerald-700" },
  { title: "Discover Topics", description: "Browse available thesis topics", icon: BookOpen, color: "bg-amber-100 text-amber-700" },
  { title: "Propose Topic", description: "Submit your own research idea", icon: FileText, color: "bg-rose-100 text-rose-700" },
  { title: "Videos", description: "Watch expert talks and tutorials", icon: Video, color: "bg-sky-100 text-sky-700" },
];
